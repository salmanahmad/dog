...
@Symbol("string.contains:substring:")
public class Contains extends Function {
	...
	public Signal resume(StackFrame frame) {
		...
		if(value instanceof StringValue && search instanceof StringValue) {
			...
			StringValue searchstring = (StringValue)search;
			returnValue = (StringUtils.contains(string.value, searchstring.value))?(new TrueValue()):(new FalseValue());
		} else {

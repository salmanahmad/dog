...
TODO - Fire when rendered for listens
TODO - Handlebar helper - link that sends listens
...
(function(scope) {
  ...
  $(".dog-form-link").live("click", function() {
    $(this).parents(".dog-form").submit()
  });
  
  Handlebars.registerHelper('send_listen', function(listen) {

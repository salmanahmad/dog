...
@Symbol("string.is_alphanumeric:")
public class IsAlphanumeric extends Function {
	...
	public Signal resume(StackFrame frame) {
		...
		if(value instanceof StringValue) {
			...
			returnValue = (StringUtils.isAlphanumeric(string.value))?new TrueValue():new FalseValue();
		} else {

...
@Symbol("string.is_all_lower_case:")
public class IsAllLowerCase extends Function {
	...
	public Signal resume(StackFrame frame) {
		...
		if(value instanceof StringValue) {
			...
			returnValue = (StringUtils.isAllLowerCase(string.value))?new TrueValue():new FalseValue();
		} else {

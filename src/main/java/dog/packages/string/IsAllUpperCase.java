...
@Symbol("string.is_all_upper_case:")
public class IsAllUpperCase extends Function {
	...
	public Signal resume(StackFrame frame) {
		...
		if(value instanceof StringValue) {
			...
			returnValue = (StringUtils.isAllUpperCase(string.value))?new TrueValue():new FalseValue();
		} else {
